...
function userData()
  {
           $.ajax({
              ...
              success: function(response) {
                  getWeather(response);  // pozivamo funkciju on ajax success da bi joj prosledili kao parametar response
...
function getWeather(response){
    ...
    $('.city').html(city + " , " + country);
        ...
        return $.ajax({
            type: "post",
            data : {city : city},
            url: "http://localhost/wordpress/wp-content/plugins/weather/api/api_call.php",
